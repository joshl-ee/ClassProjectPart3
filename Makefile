...
sources = $(wildcard $(SOURCEDIR)/**/StatusCode.java $(SOURCEDIR)/**/fdb/*.java $(SOURCEDIR)/**/models/*.java $(SOURCEDIR)/**/TableManager.java $(SOURCEDIR)/**/RecordsTransformer.java $(SOURCEDIR)/**/TableManager.java $(SOURCEDIR)/**/TableManagerImpl.java $(SOURCEDIR)/**/Cursor.java $(SOURCEDIR)/**/Records.java $(SOURCEDIR)/**/RecordsImpl.java $(SOURCEDIR)/**/test/*.java)
